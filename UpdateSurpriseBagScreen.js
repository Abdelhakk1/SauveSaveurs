...
const UpdateSurpriseBagScreen = () => {
  ...
  const [pickupHourFrom, setPickupHourFrom] = useState(new Date(surpriseBag.pickup_start_time));
  const [pickupHourTo, setPickupHourTo] = useState(new Date(surpriseBag.pickup_end_time));
